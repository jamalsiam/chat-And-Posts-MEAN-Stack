...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__chat_room_chat_room_component__ = __webpack_require__("../../../../../src/app/chat-room/chat-room.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    {
        path: 'messages/:id',
        component: __WEBPACK_IMPORTED_MODULE_9__chat_room_chat_room_component__["a" /* ChatRoomComponent */]
    },
    {
        path: 'originalpost',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__user_chat_label_user_chat_label_component__ = __webpack_require__("../../../../../src/app/user-chat-label/user-chat-label.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__chat_room_chat_room_component__ = __webpack_require__("../../../../../src/app/chat-room/chat-room.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_24__user_chat_label_user_chat_label_component__["a" /* UserChatLabelComponent */],
                __WEBPACK_IMPORTED_MODULE_25__chat_room_chat_room_component__["a" /* ChatRoomComponent */]
            ],
            imports: [
...
module.exports = "<aside class=\"Index0 {{changeSideBarStateVal}}\">\n  <div class=\"side-btn \" (click)=\"sideBarStateChanger()\"><span class=\"glyphicon glyphicon-envelope\"></span> \n    <div class=\"total-notfy\" *ngIf=\"NumbertotalNotfy(messageService.totalNotfy) !== 0\" > {{NumbertotalNotfy(messageService.totalNotfy)}}</div> \n  </div>\n  <div class=\"chatUserGruop\">\n    <chat style=\"order: 1;\" *ngFor=\"let x of xs\" [data]=\"x\" > </chat>\n\n  </div>\n\n</aside>\n"
...
var AsideBarComponent = /** @class */ (function () {
    ...
    AsideBarComponent.prototype.getSortUser = function () {
        var _this = this;
        Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_observable_interval__["a" /* interval */])(2000).subscribe(function (x) {
            _this.messageService.getSortUser({ profile: _this.service.user.id }).subscribe(function (res) {
                _this.xs = res.arrayUser;
            });
        });
    };
    AsideBarComponent.prototype.NumbertotalNotfy = function (record) {
        if (this.changeSideBarStateVal === 'closed') {
            return Object.values(record).reduce(function (a, b) {
                return (a + b);
            }, 0);
        }
        else {
...
var MainComponent = /** @class */ (function () {
    function MainComponent(servece, storage, router) {
        this.servece = servece;
        this.storage = storage;
        this.router = router;
...
// module
exports.push([module.i, ".signup-btn{\n    color: white;\n    display: block;\n    margin-top: 20px;\n    font-size: 17px;\n}", ""]);
...
var SigninComponent = /** @class */ (function () {
    ...
    SigninComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            styles: [__webpack_require__("../../../../../src/app/signup/signup.component.css"), __webpack_require__("../../../../../src/app/signin/signin.component.css")]
        }),
...
module.exports = __webpack_require__.p + "login_bg.d10bbf74fc4c71b18569.jpg";
...
/***/ "../../../../../src/app/user-chat-label/user-chat-label.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/user-chat-label/user-chat-label.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var UserChatLabelComponent = /** @class */ (function () {
    ...
    UserChatLabelComponent.prototype.ngOnInit = function () {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_observable_interval__["a" /* interval */])(2000).subscribe(function (x) {
            _this.messageService.getUserTitle({ user1: _this.data, user2: _this.service.user.id }).subscribe(function (res) {
                _this.record = res;
                if (res.notfy) {
                    _this.messageService.totalNotfy['' + res.userInfo.email] = res.notfy;
                }
            });
        });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], UserChatLabelComponent.prototype, "data", void 0);
    UserChatLabelComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'chat',
...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent.prototype.sendMessage = function (id) {
